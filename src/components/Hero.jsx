    ...
    return (
        <section className="hero">
            <div className="container">
                <h1>Transparency In Every Donation</h1>
                <p className="quote">&quot;Restoring dignity and trust in charity, block by block.&quot;</p>
                ...
                <div className="stats-grid">
                    ...
                    <div className="stat-card">
                        ...
                        <div className="stat-label">Total MRU Collected</div>
                    </div>
                    ...
                    <div className="stat-card">
                        ...
                        <div className="stat-label">Confirmed Donations</div>
                    </div>
                </div>
            </div>
        </section>
