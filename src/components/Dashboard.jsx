            ...
            <div className="container">
                ...
                <div className="dashboard-grid">
                    ...
                    <div className="dashboard-panel">
                        ...
                        <div className="donation-list">
                            {recentDonations.length === 0 ? (
                                <div style={{ color: "var(--text-muted)", padding: "1rem 0" }}>No recent donations found.</div>
                            ) : (
                    ...
                    <div className="dashboard-panel text-center flex flex-col justify-center items-center">
                        <h3 style={{ color: "var(--text-muted)", marginBottom: "1rem" }}>Total Platform Collected</h3>
                        ...
                        <p style={{ marginTop: "2rem", color: "var(--text-muted)", fontSize: "0.875rem" }}>
                            100% of all confirmed transactions are securely recorded and verifiable.
                        </p>
